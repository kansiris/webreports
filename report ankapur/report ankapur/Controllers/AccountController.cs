...
namespace report_ankapur.Controllers
{
    ...
    public class AccountController : Controller
    {
      ...
      public ActionResult Login(TblNewCustomer Login1)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    using (AnkapurEntities1 db = new AnkapurEntities1())
                    {
                        ...
                        //                        return Content("<script language='javascript' type='text/javascript'>location.href='" + @Url.Action("Index", "GetRestaurant") + "'</script>");
        ...
        {
            return Content("<script language='javascript' type='text/javascript'>sessionStorage.clear();localStorage.clear();location.href='" + @Url.Action("Login", "Account") + "'</script>");
        }
